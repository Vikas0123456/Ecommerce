...
//               Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam ratione nulla, eius velit voluptas ipsa quia in possimus rerum sit itaque unde. Maxime aperiam similique debitis animi, provident libero? Quasi aspernatur nihil voluptates dignissimos atque veritatis quod corrupti tempora, deserunt asperiores rerum, quis voluptate ab aliquam dolores culpa quisquam accusantium tenetur facere quidem? Iure nobis mollitia minima earum assumenda libero natus minus? Ut autem iure, cumque perspiciatis fugit error eaque magnam cum a consectetur quasi labore esse culpa, ullam ducimus recusandae totam quam, consequatur placeat possimus harum aspernatur. Eaque beatae corporis quaerat recusandae quas assumenda omnis labore sit natus non.
//             </p>
//             {/* <NavLink to="/contact" className='btn btn-outline-primary px-3'>Contact Us</NavLink> */}
//           </div>
//           <div className="col-md-6 d-flex justify-content-center">
//             <img src='images/office.png' alt='About Us' height="400px" width="400px"  />
//           </div>
//         </div>
//       </div>
//     </div>
...
//             <h2 class="text-coolGray-900 text-lg font-semibold">Personal info</h2>
...
//             </div>
//             <div class="w-full md:w-1/3 p-3">
//               <input class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="Doe"/>
//             </div>
//           </div>
//         </div>
//       </div>
...
const About = () => {
  return (
    <>
      <div style={{marginTop: '20px', width: '30%', marginLeft: '35%'}}>
